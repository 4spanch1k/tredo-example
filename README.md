...
- Непродающие публикации вращаются между одиннадцатью рубриками: клиентский сервис, удобство сайта, доверие к бизнесу, работа над digital-проектом, автоматизация рутины, мобильные продукты, внутренние процессы бизнеса, голосовые AI-агенты, AI-инструменты, IT-новости и практика, скрытые сбои автоматизации.
- Каждый день охватывает все одиннадцать рубрик; одинаковые рубрики не идут подряд. Если текст ушёл от назначенной темы к привычному разговору про кнопку, цену или форму, вариант отклоняется.
...
- Ежедневный IT-новостной слот использует только записи из `it_news_items`, которые собрал `it-news-radar` из настроенного RSS/Atom-источника. Без источника слот остаётся общим вопросом о практике; свежие факты, даты и цифры не выдумываются.
